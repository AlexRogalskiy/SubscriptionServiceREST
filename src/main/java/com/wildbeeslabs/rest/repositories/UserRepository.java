...
public interface UserRepository<T extends User> extends JpaRepository<T, Long> {
     ...
     * before
     */
    //SELECT o.user FROM UserSubOrder o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt > :subDate
    public final static String FIND_BY_SUB_TYPE_AND_DATE_AFTER_QUERY = "SELECT u FROM User u INNER JOIN u.subOrders o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt > :subDate";
     ...
     */
    //SELECT o.user FROM UserSubOrder o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt <= :subDate
    public final static String FIND_BY_SUB_TYPE_AND_DATE_BEFORE_QUERY = "SELECT u FROM User u INNER JOIN u.subOrders o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt <= :subDate";

    /**
     * Default query to find subscribed users by date before
     */
    //SELECT o.user FROM UserSubOrder o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt > :subDate
    public final static String FIND_BY_DATE_AFTER_QUERY = "SELECT u FROM User u INNER JOIN u.subOrders o WHERE o.createdAt > :subDate";

    /**
     * Default query to find subscribed users by date after
     */
    //SELECT o.user FROM UserSubOrder o INNTER JOIN o.subscription s WHERE s.type = :subType AND o.createdAt <= :subDate
    public final static String FIND_BY_DATE_BEFORE_QUERY = "SELECT u FROM User u INNER JOIN u.subOrders o WHERE o.createdAt <= :subDate";
